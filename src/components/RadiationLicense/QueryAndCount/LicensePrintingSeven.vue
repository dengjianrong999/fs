...
<template>
	<div class="fs-window License-window">
		...
		<div class="block">
			...
			<div class="value">
				<input type="text" class="myinput" :disabled="disabledFlag" :value="datafs.length>0?currentData.TOTAL_ACTIVITY:''">
			</div>
		</div>
		<div class="block">
			<div class="name">
			...
			<div class="value">
				<input type="text" class="myinput" :disabled="disabledFlag" :value="datafs.length>0?currentData.FREQUENCY:''">
			</div>
		</div>
		<div class="block">
			<div class="name">
