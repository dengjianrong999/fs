	...
	<div class="fs-content">
		...
		<div class="input-box">
			<div class="input-group">
				...
				<!-- <el-select filterable placeholder="--请选择--" v-model="zsgcValue1">
					<el-option v-for="item in items" :key="item.unitName" :label="item.unitName" :value="item.unitName">
					</el-option>
				</el-select> -->
			...
			<table class="table table-bordered">
				<thead>
					<tr>
						...
						<th scope="col" width="90px">法人</th>
						<th scope="col" width="180px">证书编号</th>
						<th scope="col" width="90px">有效期</th>
						<th scope="col">操作</th>
					</tr>
				</thead>
				<tbody>
					<tr v-for="(item,index) of items" :key='index'>
						...
						<td width="90px" :title="item.legalPerson">
							{{item.legalPerson}}
						</td>
						<td width="180px" :title="item.fsLicenseNo">
							{{item.fsLicenseNo}}
						</td>
						<td width="90px" :title="item.periodValidity | time">
	...
	export default {
		...
		methods: {
			...
			derive() {
				...
				_this.$http({
					method: 'get',
					url: '/bjsy-jdc/fs/unitInfo/exportxkz',
					params: temData,
					responseType: 'blob'
				}).then(res => {
					_this.deriveAll(res);
...
<style scoped>
	...
	.input-group:nth-child(n+5):nth-child(-n+6) {
		border-top: none;
	}
	...
	@media screen and (max-width: 1024px) {
		...
		.input-group:nth-child(n+3):nth-child(-n+6) {
			border-top: none;
		}
	}
</style>
